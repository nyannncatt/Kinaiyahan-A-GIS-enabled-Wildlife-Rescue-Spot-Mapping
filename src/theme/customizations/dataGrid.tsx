...
export const dataGridCustomizations = {
  MuiDataGrid: {
    styleOverrides: {
      ...
      cell: ({ theme }: ThemeCallback) => ({
        borderTopColor: (theme.vars || theme).palette.divider,
      }),

      menu: ({ theme }: ThemeCallback) => ({
      ...
      iconButtonContainer: ({ theme }: ThemeCallback) => ({
      ...
      menuIconButton: ({ theme }: ThemeCallback) => ({
        border: 'none',
        backgroundColor: 'transparent',
        '&:hover': {
      ...
      filterForm: ({ theme }: ThemeCallback) => ({
        gap: theme.spacing(1),
        alignItems: 'flex-end',
      }),

      columnsManagementHeader: ({ theme }: ThemeCallback) => ({
