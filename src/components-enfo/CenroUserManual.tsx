...
export default function CenroUserManual() {
  return (
    <Box 
    ...
    >
      <Card sx={{ p: 2, boxShadow: 1 }}>
        ...
        >
          <iframe
            src="/KINAIYAHAN CENRO OFFICER USER MANUAL.pdf#toolbar=1&navpanes=1&scrollbar=1"
            title="Kinaiyahan CENRO Officer User Manual"
            style={{
              width: '100%',
              height: '100%',
              border: 'none'
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary', mt: 2, textAlign: 'center' }}>
          ...
          <a 
            href="/KINAIYAHAN CENRO OFFICER USER MANUAL.pdf" 
            target="_blank" 
